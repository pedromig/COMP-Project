...
double GLOBAL_DOUBLE = 1;
void OR(void)
{
    int c = (aaa == GLOBAL_DOUBLE) || ((meeeh()) && shapo());
    int a = relf() | meeeh();
    int bb = relf() || meeeh();
    relf() && meeeh();
    int bbb = relf() || meeeh();
...
int main(void)
{
    ...
    w1();
    w2();
    double dividendo = 100 * 10 + 2 + 2 + 2 + 2.2 - 3 + -+-+-+-+-4 - 45 + !45 * (2 | 2 | 'a');
    short shorty = 1 + 1 + 1 * 2 * 3 * 4 * 5 * 6 * 3 & 9 * 666 + 2 + 3 + 4 ^ 1 ^ 1 ^ 1 | 1 | 1 | 1 && 2 + (0 || 1);
    int r = 1;
    char charty = 9 + 9 + 9 / 3 / 3 / 3 && 4 % 5 % 6 % 7 % 8 % 9 * 1111 + 0 + 0 + 0 * r;
    putchar(100 * 10 + 2 + 2 + 2 + 2 - 3 + -+-+-+-+-4 - 45 + !45 * (2 | 2 | 'a' & 1 ^ 01111) && 1 || 0);
